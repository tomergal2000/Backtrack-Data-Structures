...
public class BTree<T extends Comparable<T>> {
    ...
    protected ArrayDeque<Object> deq = new ArrayDeque<>();
    ...
    public void insert(T value) {
        if (root == null) {
            ...
            //insertion to empty tree occurred, add to deque
            Object[] toInsert0 = new Object[2];
            ...
            while (currentNode != null && !wasAdded) {
                ...
                if (currentNode.getNumberOfKeys() == maxDegree - 1) {
                    ...
                    //split occurred, add to deque
                    Object[] toInsert1 = new Object[2];
                    toInsert1[0] = currentNode;
                ...
                if (currentNode.isLeaf()) {
                    ...
                    //insertion occurred, add to deque
                    Object[] toInsert2 = new Object[2];
                    toInsert2[0] = currentNode;
                    toInsert2[1] = value;
        ...
        deq.addLast("end of action");//separates between actions
        ++size;
